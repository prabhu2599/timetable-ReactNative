...
export default function Friday({navigation}) {
  ...
  const [reviews, setReviews] = useState([
    ...
    { title: '10 baje', course: 'CSE5001', courseName: 'ALGO BABA' , body:'Kuch bhi padhane do samajh thodi na aana hai', faculty: 'Main ** hun jo isme aaya', key: '10' },
    { title: '11 baje', course: 'ENJOY', courseName: 'FREE' , body:'Apne se ho roobaroo', faculty: 'Lazy Lazy sa laage', key: '11' },
    { title: '2 baje', course: 'ML', courseName: 'APPLIED ML' , body:'Kuch bhi padhane do samajh thodi na aana hai ', faculty: 'Behti hawa sa tha vo', key: '14' },
  ]);
